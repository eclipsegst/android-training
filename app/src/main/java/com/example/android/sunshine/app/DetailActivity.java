...
//            }
            // If onLoadFinished happens before this, we can go ahead an set the share intent
            if (mForecast != null) {
                mShareActionProvider.setShareIntent(createShareForecastIntent());
            }
        }
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            ...
            // Now create and return a CursorLoader that weill take care of
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            Log.v(LOG_TAG, "In onLoadFinshied");
            if (!data.moveToFirst()) { return; }

            String dataString = Utility.formatDate(
