...
//            weatherTask.execute("94043");
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        /** The date/time conversion code is going to be moved outsde the asynctask later,
         ...
         */
        private String[] getWeatherDataFormJson(String forecastJsonStr, int numDays)
            ...
            // OWM returns daily forecasts based upon the local time of the ciity that is being
            // asked for, which mean that we need to know the GMT offset to translate this data
            // properly.

            // Since this data is also sent in-order and the first day is always the current day,
            // we are going to take advantage of that to get a nice normalized UTC date for all
            // of our weather.

            Time dayTime = new Time();
            dayTime.setToNow();

            // We start atthe day returned by local time. Otherwise this a mess.
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                // The date/time is return as a long,. We need to convert that into something
                ...
                // "temp" when working with temperature. It confuse everybody.
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                return getWeatherDataFormJson(forecastJasonStr, numDays);
